...
description = [[# Nebbie Dashboard (1.12.0)
...
- **`nidentbatch`**: stesso CSV input di `nbatch`; esegue oload/stat/identify e
  appende righe a `nebbie-ident-results-YYYY-MM-DD.csv` (nome oggetto, tipo,
  extra flags, vnum-attuale).
